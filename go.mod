...
require (
	...
	github.com/go-asset/generics v0.0.0-20220617124532-a25edc3ff8d4
...
require (
	...
	github.com/fluxcd/notification-controller/api v1.3.0 // indirect
	...
	github.com/weaveworks/policy-agent/api v1.0.5 // indirect
